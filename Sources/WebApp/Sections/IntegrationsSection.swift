...
struct IntegrationsSection {
    var body: some View {
        section(.id("integrations"), .class("section section-alt"), .custom(name: "aria-labelledby", value: "integrations-title")) {
            div(.class("container")) {
                ...
                div(.class("integration-grid")) {
                    IntegrationCard(
                        ...
                        name: "Hummingbird",
                        copy: "Mount generated RPC handlers alongside existing Hummingbird routes and middleware."
                    )
                    IntegrationCard(
    ...
    var body: some View {
        article(.class("integration-card")) {
            ...
            div {
                ...
                h3 { name }
                p { copy }
                span(.class("text-link unavailable-link"), .custom(name: "aria-label", value: "\(name) setup, coming soon")) {
                    "View \(name) setup"
                    small { "Coming soon" }
                }
            }
