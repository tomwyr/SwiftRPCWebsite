        ...
        footer(.class("site-footer")) {
            div(.class("container")) {
                div(.class("footer-grid")) {
                    ...
                    FooterColumn(title: "Documentation", links: ["Getting Started", "Core Concepts", "Error Handling", "Integrations"])
                    FooterColumn(title: "Resources", links: ["Examples", "Releases", "Roadmap", "Contributing"])
